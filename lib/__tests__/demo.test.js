...
var ReactVirtualizedScroll = index_1.default.ReactVirtualizedScroll;
...
var setup = function () {
    ...
    var wrapper = enzyme_1.shallow(react_1.default.createElement(ReactVirtualizedScroll, __assign({}, props)));
    return {
        props: props,
        wrapper: wrapper,
    };
